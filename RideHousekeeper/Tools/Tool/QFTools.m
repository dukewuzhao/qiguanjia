...
+ (BOOL)isMobileNumber:(NSString *)mobileNum
{
     ...
     */
    NSString * MOBILE = @"^(0|86|17951)?(13[0-9]|15[0-35-9]|17[0-9]|18[0-9]|14[579])[0-9]{8}$";
...
+ (UIViewController*)currentViewController{
    ...
    while (1)
    {
        ...
        if ([vc isKindOfClass:[XYSideViewController class]] || [vc isKindOfClass:[UIAlertController class]]) {
            ...
            }else if([[AppDelegate currentAppDelegate].mainController isKindOfClass:[ViewController class]]){
                //vc = ((UINavigationController*)vc).visibleViewController;
            }else{
                //vc = ((UINavigationController*)vc).visibleViewController;
            }
