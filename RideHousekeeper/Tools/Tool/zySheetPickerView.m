...
+(instancetype)ZYSheetStringPickerWithTitle:(NSArray *)title Andcall:(zySheetPickerViewBlock)callBack
{
    zySheetPickerView *pickerView = [[zySheetPickerView alloc]initWithFrame:[UIScreen mainScreen].bounds  andTitle:title];
    pickerView.callBack = callBack;
    return pickerView;
}

- (instancetype)initWithFrame:(CGRect)frame andTitle:(NSArray*)title
{
