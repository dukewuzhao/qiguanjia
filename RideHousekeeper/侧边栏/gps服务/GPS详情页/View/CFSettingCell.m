...
- (void)setUpAccessoryView {
    if ([_item isKindOfClass:[CFSettingArrowItem class]]) { // Cell右边箭头
        ...
        [self.headView setImage:[SGQRCodeGenerateManager generateWithDefaultQRCodeData:iconItem.icon_right imageViewWidth:self.headView.width] forState:UIControlStateNormal];
