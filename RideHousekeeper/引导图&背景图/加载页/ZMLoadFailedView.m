...
- (UIButton *)refreshButton{
    if (!_refreshButton) {
        ...
        _refreshButton.backgroundColor = [QFTools colorWithHexString:@"#00DA8C"];
        ...
        [_refreshButton mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.size.mas_equalTo(CGSizeMake(140 * ScreenWidth/375, 38 * ScreenWidth/375));
        }];
...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = [QFTools colorWithHexString:@"#f4f4f4"];
