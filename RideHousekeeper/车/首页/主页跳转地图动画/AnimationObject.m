...
//    NSLog(@"%@",[[transitionContext containerView] subviews]);
    ...
    UIBezierPath *smallCircleBP =  [UIBezierPath bezierPathWithRoundedRect:CGRectMake(20, ScreenHeight/2 - 40, ScreenWidth - 40, 80) cornerRadius:20];
    //圆圈2--大圆
    ...
    UIBezierPath *bigCircleBP = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, ScreenWidth, ScreenHeight) cornerRadius:20];
    //跳转到新视图
